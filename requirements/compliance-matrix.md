...
| REQ-BUDG-01 | Budget | ≤ EUR 1,000 landed DE | Preference | Cost model | Partial | First-order estimate €700–1,100, contingency 15%; risk: chassis, SOM, LTE, keyboard | Low | Feasible at mid-range; margin requires choices (plastic vs Al, LTE optional step) | BOM + landed cost Phase 5 |
