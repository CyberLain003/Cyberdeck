...
|---|---|---|---|---|---|---|---|---|
| OQ-001 | P1 | Which SOM family/philosophy (ARM-class soC w/ native SATA+HDMI vs PCIe-based w/ bridges)? | SATA + low idle power + B2B route-ability filter most candidates | REQ-COMP-01/03/06, REQ-PWR-02 | i.MX8M Plus-class SoM native SATA+HDMI; CM4-class only PCIe | Research Phase 3 | Phase 3 | Open |
| OQ-002 | P1 | Which 8" 4:3 panel, and what is its real power at working brightness? | Single highest-leverage runtime variable | REQ-DISP-01/02, REQ-PWR-02 | ~500–800 nit candidates; measure backlight driver | Research Phase 4 | Phase 4 | Open |
| OQ-003 | P1 | Final battery: 2× P45B (60 Wh class, +15% mass margin fails) vs 2× 50E vs 2× P50B-class? | Runtime margin + budget | REQ-PWR-01/02 | Runtime-safe: 50E or P50B-class | Sourcing Phase 4 | Phase 4 | Open |
...
| OQ-012 | P3 | Trackball: integrated optical module vs spare-part; any ergonomic priority? | Keyboard design | REQ-KB-01 | Open | User | Phase 6 | Open |